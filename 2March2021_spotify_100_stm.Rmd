...
Now, let's go back to the output from the structural topic model we ran in the [Modeling the data](#modeling-the-data) section. Here are the gamma values (probabilities of a topic within a song) for a handful of songs that I picked out of arbitrary interest for this visualization. This visualization is just to show the variability in evenness of gammas across songs.
