...
Kind of cool that "LOYALTY" by Kendrick Lamar featuring Rihanna has a pretty high gamma value for 'longing.' Meanwhile, "About Today" by The National (a sad, sad song about losing love) had higher gamma values for more topics, but the highest topic prob was 'in my feelings' (topic keywords include: falling, love, apart, drift).
<hr>
...
DM me on Twitter (at)danbtweeter or create an issue on GitHub if you'd like to leave a comment, suggestion, or critique!
